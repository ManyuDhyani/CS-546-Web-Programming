...
console.log(lab1.questionTwo(-1, 3.5, 1.5)); //Returns and then outputs NaN
...
console.log(lab1.questionThree("..>sdf"));// Returns and then outputs 3
console.log(lab1.questionThree("@%#@@$?$")); // Returns and then outputs 0
...
console.log(lab1.questionFour("Helllllleeelo, clases!", "ee")); // Returns and then outputs 1
console.log(lab1.questionFour("Hel123llllleee123lo, 123clases!", "123")); // Returns and then outputs 3
console.log(lab1.questionFour("AHel123Allllleee123lo, 123clasesA!A", "A")); // Returns and then outputs 4